...
public class Validator {
    ...
    private static final Pattern _codeStringPattern = Pattern.compile(Constants.Regex.CODE);

    private static final Pattern _emailAddressPattern = Pattern.compile(Constants.Regex.EMAIL, Pattern.CASE_INSENSITIVE);

    private static final Pattern _ipV4AddressPattern = Pattern.compile(Constants.Regex.IPV4);

    private static final Pattern _ipV6AddressPattern = Pattern.compile(Constants.Regex.IPV6);

    private static final Pattern _numberPattern = Pattern.compile(Constants.Regex.NUMBER);

    private static final Pattern _vnPhoneNumberPattern = Pattern.compile(Constants.Regex.PHONE_REGEX);

    private static final Pattern _variableNamePattern = Pattern.compile(Constants.Regex.USERNAME);
    ...
    public static boolean checkRegex(String value, String regex) {
        ...
        try {
            ...
            log.warn("Khong check duoc regex: ", e);
        }
